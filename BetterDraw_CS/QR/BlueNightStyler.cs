...
namespace QR.Drawing
{
    class BlueNightStyler : Styler
    {
        ...
        public override void Draw()
        {
            ...
            foreach(var c in wc)
            {
                paint.DrawImage(blue_img, GetCellRectangle(c.Position.Row, c.Position.Column), new Rectangle(0, 0, blue_img.Width, blue_img.Height), GraphicsUnit.Pixel);
            }
            ...
            paint.FillRectangle(new SolidBrush(Color.Black), CodePosition.X, CodePosition.Y, CodeSize.Width, CodeSize.Height);
