...
namespace QR.Drawing.Util
{
    public class Values
    {
        ...
        static public readonly string EndPoint = "EndPoint";
        static public readonly string CrossCenter = "CrossCenter";
        static public readonly string Path = "Path";
        static public readonly string Elbow = "Elbow";
        static public readonly string TCenter = "TCenter";
        static public readonly string Single = "Single";
        ...
        static public readonly string LeftUp = "LeftUp";
        static public readonly string RightUp = "RightUp";
        static public readonly string LeftDown = "LeftDown";
        static public readonly string RightDown = "RightDown";
